...
| `safety` | 3 | `python3 ../repro/run_safety.py` | `results/tables/safety.csv +1` |
...
| `figures` | 3 | `python3 ../repro/fig_ladder.py && python3 ../repro/fig_soc_traj.py && python3 ../repro/fig_soh_traj.py && python3 ../repro/fig_sop_traj.py --direction discharge && python3 ../repro/fig_sop_traj.py --direction charge` | `../results_fig_ladder.png +4` |
| `extras` | 2 | `python3 ../repro/run_extras.py` | `results/tables/alpha.csv +1` |
...
| `mcu_measure` | 25 (board) | `cd ../mcu/fw_sop && make && STM32_Programmer_CLI -c port=SWD -w Build/nmc_dst_cc/sop_bench.elf -v -rst && cd .. && python3 bench_sop.py --n 500 && cd ../analysis && python3 ../repro/run_extras.py` | `results/tables/mcu.csv` |

Full rebuild: about 800 minutes (13 h). `~` marks an estimate that was never timed.
